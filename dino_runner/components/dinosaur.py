import pygame
from dino_runner.utils.constants import (DINO_DEAD, RUNNING, RUNNING_SHIELD, RUNNING_HAMMER, 
                                         DUCKING, DUCKING_SHIELD, DUCKING_HAMMER, JUMPING, JUMPING_SHIELD,
                                         JUMPING_HAMMER, DEFAULT_TYPE, SHIELD_TYPE, HAMMER_TYPE)
