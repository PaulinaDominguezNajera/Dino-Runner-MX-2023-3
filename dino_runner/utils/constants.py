...
SHIELD_FALSE = pygame.image.load(os.path.join(IMG_DIR, "Other/shield_false.png"))
HAMMER = pygame.image.load(os.path.join(IMG_DIR, 'Other/hammer.png'))
LAVA = pygame.image.load(os.path.join(IMG_DIR, 'Other/lava.png'))
OVNI = pygame.image.load(os.path.join(IMG_DIR, 'Other/ovni.png'))
